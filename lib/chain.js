...
function initChain(callback) {
  ...
  (0, _invariant2['default'])(_whatitis2['default'].Function(callback), 'Hope: You must pass a resolver function as the first argument to the chain constructor');
...
var Chain = function () {
  ...
  function Chain(resolver) {
    ...
    this.then = function (resolve, reject) {
      if (_whatitis2['default'].Function(resolve)) {
        thenMethod(resolve);
      }
      if (_whatitis2['default'].Function(reject)) {
        catchMethod(reject);
      }
      return _this;
    };
