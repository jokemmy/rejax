  ...
  mergeOptions: function mergeOptions() {
    ...
    return options.reduce(function (lastOption, option) {
      var objectKeys = Object.keys(lastOption).filter(function (key) {
        return _whatitis2['default'].PlainObject(lastOption[key]);
      });
      objectKeys.forEach(function (key) {
        var obj = option[key];
        if (_whatitis2['default'].PlainObject(obj)) {
...
function Ajax(url, options) {
  ...
  function setXhrs() {
    return builders.reduce(function (xhrs, options) {
      ...
      if (_whatitis2['default'].Function(options)) {
        var ajax = options();
        (0, _invariant2['default'])(isAjax(ajax), 'Function of ajax() expecting a ajax-object be returned.');
  ...
  function getNext(ajaxObject) {
    (0, _invariant2['default'])(isAjax(ajaxObject), 'Function of ajax() expecting a ajax-object be returned.');
  ...
  methods.forEach(function (method) {
    chainMethod[method] = (0, _compose2['default'])(function (options) {
      ...
      return (0, _object2['default'])(chainMethod, methods);
...
Object.assign(Ajax, (0, _object2['default'])(globalMap, ['setURLTokens', 'setURLAlias', 'setDataTransform', 'setAssert', 'setGlobalOptions', 'mergeOptions']), {
  getURL: URLFormat
});
